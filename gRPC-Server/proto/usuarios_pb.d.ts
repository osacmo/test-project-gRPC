...
export class ObjectResponse extends jspb.Message { 
    clearMsgList(): void;
    getMsgList(): Array<MsgResponse>;
    setMsgList(value: Array<MsgResponse>): ObjectResponse;
    addMsg(value?: MsgResponse, index?: number): MsgResponse;
...
export namespace ObjectResponse {
    export type AsObject = {
        msgList: Array<MsgResponse.AsObject>,
    }
}
