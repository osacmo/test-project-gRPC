...
function serialize_usuarios_ObjectResponse(arg) {
  if (!(arg instanceof usuarios_pb.ObjectResponse)) {
    throw new Error('Expected argument of type usuarios.ObjectResponse');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_usuarios_ObjectResponse(buffer_arg) {
  return usuarios_pb.ObjectResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
var UsuariosService = exports.UsuariosService = {
  agregarUsuario: {
    ...
    responseType: usuarios_pb.ObjectResponse,
    requestSerialize: serialize_usuarios_Usuario,
    requestDeserialize: deserialize_usuarios_Usuario,
    responseSerialize: serialize_usuarios_ObjectResponse,
    responseDeserialize: deserialize_usuarios_ObjectResponse,
  },
  obtenerUsuarios: {
